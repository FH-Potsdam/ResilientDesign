...
#place_label[type='suburb'][zoom>=15][zoom<=18] {
  ...
  text-face-name: @sans_lt;
  text-placement: point;
  text-fill: @place_text;//@other_text;
  text-size: 11;
  text-halo-fill: @place_halo;//@other_halo;
  text-halo-radius: 1.5;
  text-halo-rasterizer: fast;
  text-wrap-width: 60;
  text-wrap-before: true;
...
#water_label {
  ...
  [zoom>=18][area>0]{
    ...
    text-wrap-width: 50;
    text-wrap-before: true;
    text-halo-fill: @water_halo;//#fff;
    text-line-spacing: -2;
    text-face-name: @sans_italic;
    text-fill: @water_text;//@water * 0.75;
  }
...
#waterway_label[class='stream_intermittent'][zoom>=17] {
  ...
  text-name: @name;
  text-face-name: @sans_italic;
  text-fill: @place_text;//@water * 0.75;
  text-halo-fill: @place_halo;//fadeout(#fff,80%);
  text-halo-radius: 1.5;
  text-halo-rasterizer: fast;
  text-placement: line;
  text-size: 10;
